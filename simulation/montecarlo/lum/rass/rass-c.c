...
int conti;
int multi;
long double a = 290.97365;
long double b = -21.927930;
long double c = 0.54940044;
long double d = -0.0045754039;
int n;

void counter(long double * array){
     FILE *fp;
     char output[]="rass-lumsim-c.dat";
     int q;
...
int main() {
  printf ("Monte Carlo Data Generator\n");
     for (i=0;i<1000000;i++){				//calculations per cycle
       x = (.6*rand()/RAND_MAX)*10 + 38;	//random x between 38 and 44
	//printf ("x %Lf \n",x);
