...
int conti;
int multi;
long double a = 70.091655;
long double b = -5.7104494;
long double c = 0.15371379;
long double d = -0.0013670982;
int n;

void counter(long double * array){
     FILE *fp;
     char output[]="rass-lumsim-m.dat";
     int q;
...
int main() {
  printf ("Monte Carlo Data Generator\n");
     for (i=0;i<1000000;i++){				//calculations per cycle
       x = (.6*rand()/RAND_MAX)*10 + 38;	//random x between 37 and 44
	//printf ("x %Lf \n",x);
