pro ahistlumbig
        ...
        data=fltarr(1000000)
        Cntrldata=fltarr(1000000)
        mfit = fltarr(300)
        cfit = fltarr(300)
        
;Read the data files

        readcol,'gdrive/jmu/astrores/su13/simulation/montecarlo/lumfromdlflux/swift/swift-m-lum.dat',data
        readcol,'gdrive/jmu/astrores/su13/simulation/montecarlo/lumfromdlflux/swift/swift-c-lum.dat',Cntrldata

;Form histogram ranges and bins
        BinDiv = 9 ; 1/2 of the number of bins
...
;Plot histogram
        ...
        TVLCT, 0, 0, 255, 3
        TVLCT, 255, 0, 0, 4
        savefile = 'gdrive/jmu/astrores/su13/simulation/montecarlo/lumfromdlflux/swift/swift-simlum.eps'
        set_plot,'ps'
