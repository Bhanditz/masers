...
;Loop accepts file input
print,'The first dialog box asks for shortened table input.'
shortfile = DIALOG_PICKFILE(FILTER='*.dat', PATH='gdrive/jmu/astrores/su13/margins')
;print,'The second dialog box asks for rayleigh input.'
...
httl=''
xtot=x[n-1]
plot,x-0.5,y,psym=10,THICK=8,xtitle='angular separation in arcseconds',$
    ytitle='matches',title=httl,XRANGE=[0,xtot],XSTYLE=1.0,XMINOR=1,$
    XTHICK=3.75,YTHICK=3.75,CHARTHICK=7,CHARSIZE=2.25
;OPLOT,x,ray, psym=0, THICK=6, linestyle=1
OPLOT, [0,0.5], [95,95],THICK=8
OPLOT, [6.5,7.0], [3,3],THICK=8
xyouts,30,80,CHARSIZE=3,CHARTHICK=6, ''
device,/close
set_plot,'x'
...
fttl=''
xtot=x[n-1]
plot,x,prif,xtitle='angular separation in arcseconds',ytitle='PIF',$
    title=fttl,XRANGE=[0,xtot],XSTYLE=1.0,XMINOR=1,$
    XTHICK=3.75,YTHICK=3.75,CHARTHICK=7,CHARSIZE=2.25,thick=8
xyouts,55,5,CHARSIZE=3,CHARTHICK=6, ''
device,/close
set_plot,'x'
