...
;Read the data files
        ...
        mfile = DIALOG_PICKFILE(FILTER='*.dat', PATH='gdrive/jmu/astrores/su13/luminosity')
        OPENR,1,mfile
        ...
        cfile = DIALOG_PICKFILE(FILTER='*.dat', PATH='gdrive/jmu/astrores/su13/luminosity')
        OPENR,1,cfile
...
;Plot histogram
        ...
        savefile = DIALOG_PICKFILE(FILTER='*.eps', PATH='gdrive/jmu/astrores/su13/luminosity')
        set_plot,'ps'
